...
function shownew(users, downusers, net_intr_down_data, net_intr_layer, nowceng, cengnum) {
  ...
  for (var index in users[net_intr_down_data]) {
    ...
    htmlstr = htmlstr + '</tr></tbody></table><img style="width:1px;height:20px;line-height:20px" alt="" src="/static/line2.gif" border="0"></td></tr></tbody></table><table width="100" border="1"  cellpadding="0" cellspacing="1"  align="center"   class="thistable"><tbody><tr><td align="center" class="la4"><table width="100%" border="0" cellspacing="1" cellpadding="0" id="overUser_000002"><tbody><tr><td  class="nettd" ';
